namespace SoftUni.Data
{
    ...
    {
        /* Empty constructor will be used by us during development */
        public SoftUniContext()
        {

        }

        /* Constructor with DbContextOptions<TDB> will be used by Judge during evaluation */
        ...
        {
            /* EF Fluent API - public API for configuring DB constraints */
